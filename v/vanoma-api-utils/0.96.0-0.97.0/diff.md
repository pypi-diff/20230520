# Comparing `tmp/vanoma_api_utils-0.96.0.tar.gz` & `tmp/vanoma_api_utils-0.97.0.tar.gz`
...
### Comparing `vanoma_api_utils-0.96.0/pyproject.toml` & `vanoma_api_utils-0.97.0/pyproject.toml`
