# Comparing `tmp/pioreactor_relay_plugin-0.3.1-py3-none-any.whl.zip` & `tmp/pioreactor_relay_plugin-0.4.0-py3-none-any.whl.zip`
...
## Comparing `pioreactor_relay_plugin-0.3.1.dist-info/LICENSE.txt` & `pioreactor_relay_plugin-0.4.0.dist-info/LICENSE.txt`

 * *Files identical despite different names*

## Comparing `pioreactor_relay_plugin-0.3.1.dist-info/METADATA` & `pioreactor_relay_plugin-0.4.0.dist-info/METADATA`
...
## Comparing `pioreactor_relay_plugin-0.3.1.dist-info/RECORD` & `pioreactor_relay_plugin-0.4.0.dist-info/RECORD`
