# Comparing `tmp/SplatStats-2.0.3.tar.gz` & `tmp/SplatStats-2.0.4.tar.gz`
...
## Comparing `SplatStats-2.0.3.tar` & `SplatStats-2.0.4.tar`
...
### Comparing `SplatStats-2.0.3/LICENSE` & `SplatStats-2.0.4/LICENSE`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/PKG-INFO` & `SplatStats-2.0.4/PKG-INFO`
...
### Comparing `SplatStats-2.0.3/README.md` & `SplatStats-2.0.4/README.md`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/Battle.py` & `SplatStats-2.0.4/SplatStats/Battle.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/Player.py` & `SplatStats-2.0.4/SplatStats/Player.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/StatInk.py` & `SplatStats-2.0.4/SplatStats/StatInk.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/Team.py` & `SplatStats-2.0.4/SplatStats/Team.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/__init__.py` & `SplatStats-2.0.4/SplatStats/__init__.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/auxiliary.py` & `SplatStats-2.0.4/SplatStats/auxiliary.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/colors.py` & `SplatStats-2.0.4/SplatStats/colors.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/constants.py` & `SplatStats-2.0.4/SplatStats/constants.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/files.py` & `SplatStats-2.0.4/SplatStats/files.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/parsers.py` & `SplatStats-2.0.4/SplatStats/parsers.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/plots.py` & `SplatStats-2.0.4/SplatStats/plots.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/plotsAux.py` & `SplatStats-2.0.4/SplatStats/plotsAux.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/plotsTeam.py` & `SplatStats-2.0.4/SplatStats/plotsTeam.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/statInkConstants.py` & `SplatStats-2.0.4/SplatStats/statInkConstants.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/statInkPlots.py` & `SplatStats-2.0.4/SplatStats/statInkPlots.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/statInkStats.py` & `SplatStats-2.0.4/SplatStats/statInkStats.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats/stats.py` & `SplatStats-2.0.4/SplatStats/stats.py`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/SplatStats.egg-info/PKG-INFO` & `SplatStats-2.0.4/SplatStats.egg-info/PKG-INFO`
...
### Comparing `SplatStats-2.0.3/SplatStats.egg-info/SOURCES.txt` & `SplatStats-2.0.4/SplatStats.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `SplatStats-2.0.3/setup.py` & `SplatStats-2.0.4/setup.py`
